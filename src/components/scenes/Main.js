...
import { Scene, Color, ArrowHelper, Vector3, AxesHelper, TextureLoader, RepeatWrapping, ClampToEdgeWrapping, MirroredRepeatWrapping, CubeTextureLoader, Fog, MeshBasicMaterial, FogExp2, MeshDistanceMaterial, MeshNormalMaterial, MeshLambertMaterial } from 'three';
...
class MainScene extends Scene {
    constructor() {
        ...
        const nebulaTexture = new TextureLoader().load("src/components/textures/nebula.png");
        ...
        this.planet = new Planet('planetOne');
    ...
    changePlanet(currPlanet){
      this.remove(this.planet);
      this.planet = new Planet(currPlanet);
