...
class UIScene extends Scene {
    constructor(camX, camY) {
        ...
        const currFlower = new RoundedButton(camX*.5, camY*.8, 1, 0xc072d4, "currFlower");
        currFlower.SetPosition(-camX + currFlower.width/2, -camY + currFlower.length/2, 0);
        this.add( currFlower );

        const flowerZero = new RoundedButton(currFlower.width*.8, currFlower.width*.8, 2, 0xff0000, "flowerZero");
